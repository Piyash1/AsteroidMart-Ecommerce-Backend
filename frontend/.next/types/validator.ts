...
// Validate ..\..\app\cart\[cartcode]\page.tsx
{
  const handler = {} as typeof import("..\\..\\app\\cart\\[cartcode]\\page.js")
  handler satisfies AppPageConfig<"/cart/[cartcode]">
}
...
// Validate ..\..\app\categories\[slug]\page.tsx
{
  ...
  handler satisfies AppPageConfig<"/categories/[slug]">
}
