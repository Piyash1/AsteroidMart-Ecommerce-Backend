...
async function addReview(data) {
    try {
        const response = await api.post('add_review/', data);
        return response.data;
    } catch (err) {
        if (err instanceof Error) {
            throw new Error(err.message);
...
;
const Button = (param)=>{
    let { className, children, disabled, ...rest } = param;
    ...
    callbacks: {
        async signIn (param) {
            ...
            try {
                ...
                const first_name = profile === null || profile === void 0 ? void 0 : profile.given_name;
                const last_name = profile === null || profile === void 0 ? void 0 : profile.family_name;
                const username = profile === null || profile === void 0 ? void 0 : (_profile_name = profile.name) === null || _profile_name === void 0 ? void 0 : _profile_name.split("@")[0];
                const profile_picture_url = profile === null || profile === void 0 ? void 0 : profile.picture;
                const userObj = {
                    email,
                    first_name,
                    last_name,
                ...
                try {
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getExistingUser"])(email);
                } catch (err) {
                    console.log(err);
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createNewUser"])(userObj);
                }
                return true;
            } catch (err) {
                return false;
...
const ReviewForm = (param)=>{
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            const email = session === null || session === void 0 ? void 0 : (_session_user = session.user) === null || _session_user === void 0 ? void 0 : _session_user.email;
            if (!email) {
                alert("Please sign in to add a review");
                return;
            }
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addReview"])({
            ...
            else alert("Failed to add review");
        } finally{
            setSubmitting(false);
        }
    };
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$uiComponents$2f$Button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                        ...
                        disabled: submitting || !clickedRating,
                        children: "Add Review"
                    }, void 0, false, {
                        fileName: "[project]/components/productDetail/ReviewForm.tsx",
                        lineNumber: 116,
...
_s(ReviewForm, "MLetxDlqjwbvJqWiMLKRH+yuFCw=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
...
//# sourceMappingURL=_b597b2d5._.js.map